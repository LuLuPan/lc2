...
Solution:
Iterative: Use upper level next connect which already built a level order
traversal to build current level connections.
...
public class Solution {
    public void connect(TreeLinkNode root) {
        ...
        while (root != null) {
            TreeNode next = null; // first node in next level
            TreeNode prev = null; // traverse current level
            // scan in level order
